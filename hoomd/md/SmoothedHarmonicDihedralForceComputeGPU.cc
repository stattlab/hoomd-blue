...
/*! \file SmoothedHarmonicDihedralForceComputeGPU.cc
    \brief Defines SmoothedHarmonicDihedralForceComputeGPU
*/

#include "SmoothedHarmonicDihedralForceComputeGPU.h"
 ...
 */
SmoothedHarmonicDihedralForceComputeGPU::SmoothedHarmonicDihedralForceComputeGPU(
    std::shared_ptr<SystemDefinition> sysdef)
    : SmoothedHarmonicDihedralForceCompute(sysdef)
    {
...
*/
void SmoothedHarmonicDihedralForceComputeGPU::setParams(unsigned int type,
                                                Scalar K,
                                                Scalar sign,
                                                int multiplicity,
                                                Scalar phi_0)
    {
    SmoothedHarmonicDihedralForceCompute::setParams(type, K, sign, multiplicity, phi_0);
...
*/
void SmoothedHarmonicDihedralForceComputeGPU::computeForces(uint64_t timestep)
    {
    ...
    this->m_tuner->begin();
    kernel::gpu_compute_smoothed_harmonic_dihedral_forces(d_force.data,
                                                 d_virial.data,
                                                 m_virial.getPitch(),
                                                 m_pdata->getN(),
                                                 d_pos.data,
...
namespace detail
    {
void export_SmoothedHarmonicDihedralForceComputeGPU(pybind11::module& m)
    {
    pybind11::class_<SmoothedHarmonicDihedralForceComputeGPU,
                     SmoothedHarmonicDihedralForceCompute,
                     std::shared_ptr<SmoothedHarmonicDihedralForceComputeGPU>>(
        m,
