...
/*! \file SmoothedHarmonicDihedralForceGPU.cu
...
*/
__global__ void gpu_compute_smoothed_harmonic_dihedral_forces_kernel(Scalar4* d_force,
                                                            Scalar* d_virial,
...
*/
hipError_t gpu_compute_smoothed_harmonic_dihedral_forces(Scalar4* d_force,
                                                Scalar* d_virial,
                                                const size_t virial_pitch,
                                                const unsigned int N,
                                                const Scalar4* d_pos,
    ...
    // run the kernel
    hipLaunchKernelGGL((gpu_compute_smoothed_harmonic_dihedral_forces_kernel),
                       grid,
                       threads,
                       0,
                       0,
