...
void export_BoxDim(pybind11::module& m)
    ...
    pybind11::class_<BoxDim, std::shared_ptr<BoxDim>>(m, "BoxDim")
        ...
        .def("getAlpha", &BoxDim::getAlpha)
        .def("setAlpha", &BoxDim::setAlpha)
        //.def("getAlphaQuat", &BoxDim::getAlphaQuat)
        .def("setAlphaQuat", &BoxDim::setAlphaQuat)
        .def("getAlphaQuat", &BoxDim::getPythonAlphaQuat)
        .def("getUseRotatedBoundaries", &BoxDim::getUseRotatedBoundaries)
        .def("setUseRotatedBoundaries", &BoxDim::setUseRotatedBoundaries)
